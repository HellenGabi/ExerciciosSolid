...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Invoice invoice = service.creatInvoice("INV-001", "hellen_scarantti@gmail.com", items, tax);
        System.out.println("Fatura criada: " + invoice.getId() + " Total=" + invoice.getTotal());

        List<Double> items2 = Arrays.asList(200.0, 50.0);


        Invoice invoice2 = service.creatInvoice("INV-002", "deivison_sillas@edu.sc.senai.br", items2, tax);
